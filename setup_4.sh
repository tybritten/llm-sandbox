...
echo "You'll also need to export the storage class for the model storage to STORAGE_CLASS"
echo "If this is a single node you can just use 'mayastor' if you have more than one node, use mayastor-<number of nodes>"
echo " for example two node export STORAGE_CLASS=mayastor-2"
